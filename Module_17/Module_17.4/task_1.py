...
print('Задача 1. Минимум и максимум')
...
print((max(grades, key=lambda el: el['score']))['score'])
print(min(grades, key=func))
print(list(map(lambda el: el['score'], sorted(grades, key=func))))
